...
bin/program: build/main.o build/project.o
	mkdir -p  bin
	gсс -Wall build/main.o build/project.o -o bin/program

build/main.o: src/main.c
	mkdir -p build
	gсс -Wall -c src/main.c -o build/main.o
...
build/test.o: test/main.c
	mkdir -p build
	gсс -I src -I lib -Wall -c test/main.c -o build/test.o  

build/project_test.o: test/project_test.c
	mkdir -p build
	gсс -I src -I lib -Wall -c test/project_test.c -o build/project_test.o 
